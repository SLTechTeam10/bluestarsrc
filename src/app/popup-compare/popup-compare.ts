...
@Component({
  ...
  templateUrl: 'popup-compare.html',
  styleUrls: ['./popup-compare.scss']
})

export class PopupCompare {
  ...
  constructor(public modalCtrl: ModalController, private route: ActivatedRoute,
    ...
    console.log("title PopupCompare", this.title);
    ...
    this.loadingController.create({
      ...
      this.storage.get('compareList').then((val) => {
        ...
        if (val != null) {
          ...
          // var getCss = document.getElementById('ion-overlay-3');
