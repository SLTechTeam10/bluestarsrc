...
import { ProductListingModel } from '../../../product/listing/product-listing.model';
...
export class DataStoreMultiplePage implements OnInit {
  ...
  dataStoreB: DataStore<ProductListingModel>;
  // dataA: TravelListingModel;
  dataB: ProductListingModel;
  ...
  ngOnInit() {
    ...
    const shellModelB: ProductListingModel = new ProductListingModel();
